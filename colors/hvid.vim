...
if (&background ==# "dark" && get(g:, "colors_name", "") ==# "hvid")
    runtime! colors/sort.vim
    finish
endif
...
call s:hi('DiffText', s:palette.white, s:palette.blue, '')
...
call s:hi('MatchParen', s:palette.red, s:palette.white, '')
